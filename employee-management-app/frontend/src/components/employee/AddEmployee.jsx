  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        ...
        const stateRes = await employeeAPI.getStates();
        setStates(stateRes?.data || []);
      } catch (error) {
        setServerError("Failed to load master data");
      }
    };
    fetchInitialData();
  }, []);
            ...
            <Form className="space-y-8">
              ...
              <div className="flex flex-col items-center">
                <div className="relative group">
                  {/* Profile Image (Default or Preview) */}
                  <img
                ...
                <p className="text-slate-500 text-sm mt-3">Upload Profile Picture</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Select
                    options={departments}
                    value={
                      departments.find((d) => d.value === values.department) ||
                      null
                    }
                    onChange={(selected) =>
                      setFieldValue(
